...
export async function pairWithDeviceByCode(
  ...
  if (!device) return { success: false, message: 'Bu eşleştirme koduna ait bilgisayar bulunamadı. Lütfen bilgisayarınızdaki Eon uygulamasının açık ve Ayarlar sekmesinde Supabase bağlantısının yeşil (çevrim içi) olduğundan emin olun.' }
