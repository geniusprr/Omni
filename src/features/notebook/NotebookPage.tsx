            ...
            <div className="transfers-list-scroll">
              {transfers.length === 0 ? (
                <div className="empty-state">
                  ...
                  <span>Telefondaki Kapanış uygulamasından fotoğraf veya dosya seçip anında gönderin.</span>
                </div>
              ) : (
            ...
            <div className="qr-modal-body">
              ...
              <div className="qr-instructions">
                ...
                <p className="qr-subtext">
                  Kapanış Mobil uygulamasında QR kodu okutabilir veya 6 haneli kodu girerek dünyanın her yerinden uzaktan bağlanabilirsiniz.
                </p>
              </div>
            </div>
          </div>
